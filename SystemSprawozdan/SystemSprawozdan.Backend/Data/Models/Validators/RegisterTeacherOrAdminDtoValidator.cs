...
{
    public class RegisterTeacherOrAdminDtoValidator : AbstractValidator<RegisterTeacherOrAdminDto>
    {
        public RegisterTeacherOrAdminDtoValidator(ApiDbContext apiDbContext)
        {
